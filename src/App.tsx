        ...
        <div className="p-3 border-t border-[var(--color-border)] space-y-1">
          ...
          {isSupabaseConfigured() && (
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold text-[var(--color-text-secondary)] hover:text-red-500 hover:bg-red-500/5 transition-all"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9"/></svg>
              <span>Выйти</span>
            </button>
          )}
        </div>
            ...
            <div className="lg:hidden border-t border-[var(--color-border)]/50 bg-[var(--color-surface)]/95 backdrop-blur-md max-h-[80vh] overflow-y-auto">
              <div className="px-4 py-3 space-y-4">
                ...
                {isSupabaseConfigured() && (
                  <button
                    onClick={handleSignOut}
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-[var(--color-text-secondary)] hover:text-red-500 hover:bg-red-500/5 transition-all"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9"/></svg>
                    <span>Выйти</span>
                  </button>
